...
part of '../../data/model/example.dart';
...
class _$_ExampleModel implements _ExampleModel {
  const _$_ExampleModel({required this.id, required this.name});
...
abstract class _ExampleModel implements ExampleModel {
  const factory _ExampleModel(
      {required final int id, required final String name}) = _$_ExampleModel;
